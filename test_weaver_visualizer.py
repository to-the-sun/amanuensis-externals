...
def test_visualizer():
    ...
    for i in range(100):
        ...
        if i == 25:
            sock.sendall(b'{"track": 1, "ms": 250.0, "palette": "kick", "offset": 100.0, "bar": "0", "len": 1000, "f2": 0.0}\n')
        if i == 50:
            sock.sendall(b'{"track": 2, "ms": 500.0, "palette": "snare", "offset": 200.0, "bar": "16", "len": 2000, "f2": 1.0}\n')

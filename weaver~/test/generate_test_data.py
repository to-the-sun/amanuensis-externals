...
def build_transcript_and_palette_audio(script_dir):
    """
...
def main():
    ...
    print(f"Synthesizing audio palette files and transcript dictionary in {script_dir}...")
    transcript_data = build_transcript_and_palette_audio(script_dir)

    out_path = script_dir / "transcript.json"

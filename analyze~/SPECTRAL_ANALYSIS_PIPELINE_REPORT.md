...
5.  **Peak Detection**: Identifies transients using a 15-second rolling midpoint threshold, 200ms suppression, and an adaptive midpoint-based prominence check (`prom > midpoint`).
